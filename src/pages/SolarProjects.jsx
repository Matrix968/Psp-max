  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0a0f1e] flex flex-col items-center justify-center">
        ...
        <p className="text-gray-400">Loading solar projects...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] py-12">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">☀️ Solar Projects</h1>
          <p className="text-gray-400">
            Browse our portfolio of solar installations 
        ...
        {filteredProjects.length === 0 ? (
          <div className="text-center py-16 bg-[#131b2e] rounded-2xl border border-white/10">
            {projects.length === 0 ? (
              <>
                <p className="text-gray-400 text-lg mb-2">No solar projects yet</p>
                <p className="text-gray-500 text-sm">Start by adding your first solar project</p>
                <Link 
              ...
              >
                ...
                <div className="relative h-52 overflow-hidden bg-[#0a0f1e]">
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80';
                    }}
                  />
                  {/* Category Badge */}
                  <div className="absolute top-3 left-3 bg-amber-500/90 text-white text-xs font-semibold px-3 py-1 rounded-full backdrop-blur-sm">
                    ☀️ Solar
                  </div>
        ...
        {filteredProjects.length > 0 && (
          <div className="mt-8 text-center text-sm text-gray-500">
            Showing {filteredProjects.length} of {projects.length} solar projects
          </div>
        )}
      </div>
    </div>
